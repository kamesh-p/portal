...
export default async function handler(req, res) {
  if (req.method === 'POST') {
    ...
    try {
      ...
      const databaseName = 'question'; // Replace with your desired database name
      const collectionName = 'survey'; // Replace with your desired collection name
      ...
      res.status(201).json({ message: `Successfully updated ${result.insertedCount} questions in the database.` });
    } catch (error) {
